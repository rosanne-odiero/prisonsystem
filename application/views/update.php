...
<div class="container">
<?php echo form_open("doctor/change/{$post->id}", ['class'=>'form-horizontal']); ?>
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
      <?php echo form_input(['name'=>'patient_name', 'placeholder'=>'Patient Name','class'=>'form-control', 'value'=>set_value('patient_name',$post->patient_name)]);?>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
      <?php echo form_input(['name'=>'allergies', 'placeholder'=>'Patient Allergies','class'=>'form-control' , 'value'=>set_value('allergies',$post->allergies)]);?>
      </div>
      <!-- div for displaying errors -->
    <div class="col-md-5">
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
      <?php echo form_input(['name'=>'previous_diagnosis', 'placeholder'=>'Patient Diagnosis','class'=>'form-control' , 'value'=>set_value('previous_diagnosis',$post->previous_diagnosis)]);?>
      </div>
      <!-- div for displaying errors -->
    <div class="col-md-5">
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
      <?php echo form_input(['name'=>'weight', 'placeholder'=>'Patient Weight','class'=>'form-control', 'value'=>set_value('weight',$post->weight)]);?>
      </div>
      <!-- div for displaying errors -->
    <div class="col-md-5">
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
      <?php echo form_input(['name'=>'previous_prescription', 'placeholder'=>'Patient Prescription','class'=>'form-control', 'value'=>set_value('previous_prescription',$post->previous_prescription)]);?>
      </div>
      <!-- div for displaying errors -->
    <div class="col-md-5">
